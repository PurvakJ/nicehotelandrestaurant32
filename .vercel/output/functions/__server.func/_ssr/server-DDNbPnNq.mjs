...
import { t as getServerFnById } from "../__23tanstack-start-server-fn-resolver-ghBx3mck.mjs";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-CpaiL7aU.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-BcqKE4N_.mjs"),
		import("./start-S-dW0WNJ.mjs"),
