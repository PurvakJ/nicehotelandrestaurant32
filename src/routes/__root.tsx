...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "Nice Hotel And Restaurant" },
      { name: "twitter:description", content: "Luxury rooms, fine dining and elegant event venues in Mansa, Punjab." },
