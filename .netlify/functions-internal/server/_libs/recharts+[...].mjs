...
var generatePrefixStyle = function generatePrefixStyle(name, value) {
	...
	var result = PREFIX_LIST.reduce(function(res, entry) {
		return _objectSpread$7(_objectSpread$7({}, res), {}, _defineProperty$9({}, entry + camelName, value));
	}, {});
	result[name] = value;
	return result;
};
...
var Brush = /*#__PURE__*/ function(_PureComponent) {
	function Brush(props) {
		...
		_this = _callSuper$5(this, Brush, [props]);
		_defineProperty$8(_this, "handleDrag", function(e) {
			if (_this.leaveTimer) {
		...
		_defineProperty$8(_this, "handleTouchMove", function(e) {
			if (e.changedTouches != null && e.changedTouches.length > 0) _this.handleDrag(e.changedTouches[0]);
		});
		_defineProperty$8(_this, "handleDragEnd", function() {
			_this.setState({
				isTravellerMoving: false,
				isSlideMoving: false
			}, function() {
		...
		_defineProperty$8(_this, "handleLeaveWrapper", function() {
		...
		_defineProperty$8(_this, "handleEnterSlideOrTraveller", function() {
			_this.setState({ isTextActive: true });
		});
		_defineProperty$8(_this, "handleLeaveSlideOrTraveller", function() {
			_this.setState({ isTextActive: false });
		});
		_defineProperty$8(_this, "handleSlideDragStart", function(e) {
	...
	return _createClass$6(Brush, [
		...
		},
		{
			...
			value: function handleTravellerMove(e) {
				...
				this.setState(_defineProperty$8(_defineProperty$8({}, movingTravellerId, prevValue + delta), "brushMoveStartX", e.pageX), function() {
					if (onChange) {
		...
		},
		{
			...
			value: function handleTravellerMoveKeyboard(direction, id) {
				...
				this.setState(_defineProperty$8({}, id, newScaleValue), function() {
		...
		},
		{
			...
			value: function renderText() {
				...
				return /*#__PURE__*/ import_react.createElement(Layer, { className: "recharts-brush-texts" }, /*#__PURE__*/ import_react.createElement(Text, _extends$6({
					textAnchor: "end",
					verticalAnchor: "middle",
					x: Math.min(startX, endX) - offset,
					y: y + height / 2
				}, attrs), this.getTextOfTick(startIndex)), /*#__PURE__*/ import_react.createElement(Text, _extends$6({
					textAnchor: "start",
					verticalAnchor: "middle",
...
_defineProperty$8(Brush, "displayName", "Brush");
_defineProperty$8(Brush, "defaultProps", {
	height: 40,
	travellerWidth: 5,
	gap: 1,
	fill: "#fff",
...
var ReferenceDot = /*#__PURE__*/ function(_React$Component) {
	function ReferenceDot() {
		_classCallCheck$5(this, ReferenceDot);
		return _callSuper$4(this, ReferenceDot, arguments);
	}
	_inherits$4(ReferenceDot, _React$Component);
	return _createClass$5(ReferenceDot, [{
		key: "render",
		value: function render() {
...
_defineProperty$7(ReferenceDot, "displayName", "ReferenceDot");
_defineProperty$7(ReferenceDot, "defaultProps", {
	isFront: false,
	ifOverflow: "discard",
	xAxisId: 0,
	yAxisId: 0,
...
_defineProperty$7(ReferenceDot, "renderDot", function(option, props) {
	var dot;
...
var renderLine = function renderLine(option, props) {
	...
	else line = /*#__PURE__*/ import_react.createElement("line", _extends$4({}, props, { className: "recharts-reference-line-line" }));
	return line;
};
...
_defineProperty$6(ReferenceLine, "displayName", "ReferenceLine");
_defineProperty$6(ReferenceLine, "defaultProps", {
	isFront: false,
	ifOverflow: "discard",
	xAxisId: 0,
	yAxisId: 0,
...
var ReferenceArea = /*#__PURE__*/ function(_React$Component) {
	function ReferenceArea() {
		...
		return _callSuper$2(this, ReferenceArea, arguments);
	}
	_inherits$2(ReferenceArea, _React$Component);
	return _createClass$3(ReferenceArea, [{
		key: "render",
		value: function render() {
...
_defineProperty$5(ReferenceArea, "displayName", "ReferenceArea");
_defineProperty$5(ReferenceArea, "defaultProps", {
	isFront: false,
	ifOverflow: "discard",
	xAxisId: 0,
	yAxisId: 0,
...
_defineProperty$5(ReferenceArea, "renderRect", function(option, props) {
	var rect;
	...
	else rect = /*#__PURE__*/ import_react.createElement(Rectangle, _extends$3({}, props, { className: "recharts-reference-area-rect" }));
	return rect;
});
//#endregion
...
var AccessibilityManager = /*#__PURE__*/ function() {
	function AccessibilityManager() {
		...
		_defineProperty$4(this, "activeIndex", 0);
		_defineProperty$4(this, "coordinateList", []);
		_defineProperty$4(this, "layout", "horizontal");
	}
...
var Cross = function Cross(_ref) {
	...
	return /*#__PURE__*/ import_react.createElement("path", _extends$2({}, filterProps(props, true), {
...
var getAxisMapByAxes = function getAxisMapByAxes(props, _ref2) {
	...
	return axes.reduce(function(result, child) {
		...
		return _objectSpread(_objectSpread({}, result), {}, _defineProperty$1({}, axisId, _objectSpread(_objectSpread({}, childProps), {}, {
			axisType,
			domain,
			categoricalDomain,
			duplicateDomain,
...
var getAxisMapByItems = function getAxisMapByItems(props, _ref3) {
	...
	return graphicalItems.reduce(function(result, child) {
		...
		if (!result[axisId]) {
			...
			return _objectSpread(_objectSpread({}, result), {}, _defineProperty$1({}, axisId, _objectSpread(_objectSpread({ axisType }, Axis.defaultProps), {}, {
				hide: true,
...
var calculateOffset = function calculateOffset(_ref5, prevLegendBBox) {
	...
	var offsetH = Object.keys(yAxisMap).reduce(function(result, id) {
		...
		if (!entry.mirror && !entry.hide) return _objectSpread(_objectSpread({}, result), {}, _defineProperty$1({}, orientation, result[orientation] + entry.width));
		return result;
	}, {
		left: margin.left || 0,
	...
	var offset = _objectSpread(_objectSpread({}, Object.keys(xAxisMap).reduce(function(result, id) {
		...
		var orientation = entry.orientation;
		if (!entry.mirror && !entry.hide) return _objectSpread(_objectSpread({}, result), {}, _defineProperty$1({}, orientation, (0, import_get.default)(result, "".concat(orientation)) + entry.height));
		return result;
	}, {
		top: margin.top || 0,
		...
		graphicalItems.forEach(function(item, index) {
			...
			if (composedFn) formattedItems.push({
				props: _objectSpread(_objectSpread({}, composedFn(_objectSpread(_objectSpread({}, axisObj), {}, {
					...
					dataStartIndex,
					dataEndIndex
				}))), {}, _defineProperty$1(_defineProperty$1(_defineProperty$1({ key: item.key || "item-".concat(index) }, numericAxisName, axisObj[numericAxisName]), cateAxisName, axisObj[cateAxisName]), "animationId", updateId)),
	...
	*/
	...
	var CategoricalChartWrapper = /*#__PURE__*/ function(_Component) {
		function CategoricalChartWrapper(_props) {
			...
			_this = _callSuper$1(this, CategoricalChartWrapper, [_props]);
		...
		return _createClass$1(CategoricalChartWrapper, [
			{
				key: "componentDidMount",
				value: function componentDidMount() {
			...
			},
			{
				...
				value: function render() {
					...
					}, /*#__PURE__*/ import_react.createElement(Surface, _extends$1({}, attrs, {
						width,
						height,
						title,
						desc
	...
	_defineProperty$1(CategoricalChartWrapper, "defaultProps", _objectSpread({
		layout: "horizontal",
		stackOffset: "none",
		barCategoryGap: "10%",
		barGap: 4,
	...
	var CategoricalChart = /*#__PURE__*/ (0, import_react.forwardRef)(function CategoricalChart(props, ref) {
		return /*#__PURE__*/ import_react.createElement(CategoricalChartWrapper, _extends$1({}, props, { ref }));
	});
...
//#endregion
export { CartesianGrid as a, Tooltip as c, Area as i, BarChart as n, Bar as o, XAxis as r, ResponsiveContainer as s, AreaChart as t };
